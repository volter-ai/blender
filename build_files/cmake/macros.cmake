...
# Cross builds may override these with explicit native host-tool paths.
if(NOT DEFINED BLENDER_DATATOC_COMMAND)
  set(BLENDER_DATATOC_COMMAND datatoc)
endif()
if(NOT DEFINED BLENDER_SHADER_TOOL_COMMAND)
...
function(data_to_c
  ...
  add_custom_command(
    OUTPUT ${file_to}
    COMMAND ${BLENDER_DATATOC_COMMAND} ${file_from} ${file_to} ${symbol_name_override}
...
function(data_to_c_simple
  ...
  add_custom_command(
    OUTPUT  ${_file_to}
    COMMAND ${BLENDER_DATATOC_COMMAND} ${_file_from} ${_file_to}
...
function(glsl_to_c
  ...
  add_custom_command(
    ...
    DEPFILE ${_file_dep}
    COMMAND ${BLENDER_SHADER_TOOL_COMMAND} ${_file_from} ${_file_tmp} ${_file_meta} ${_file_info} ${_file_dep} ${_inc_list}
    DEPENDS ${_file_from} shader_tool)

  add_custom_command(
    OUTPUT  ${_file_to}
    COMMAND ${BLENDER_DATATOC_COMMAND} ${_file_tmp} ${_file_to}
